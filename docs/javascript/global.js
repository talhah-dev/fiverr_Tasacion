...
<div
    class="bottomToTop fadeIn w-12 cursor-pointer z-40 bg-slate-900 h-12 fixed bottom-5 right-5 hover:opacity-80 transition-all duration-500 hidden text-zinc-100 flex items-center justify-center rounded-full "><i class="fa-solid fa-angle-up"></i>
</div>`
